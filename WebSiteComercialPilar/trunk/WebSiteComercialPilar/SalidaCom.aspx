<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageComun.Master" AutoEventWireup="true" CodeBehind="SalidaCom.aspx.cs" Inherits="WebSiteComercialPilar.SalidaCom" %>
        ...
        <table style="width:100%;">
            <tr>
                <td class="style6" colspan="3">
                    <strong>HOJAS DE PEDIDOS PAGADAS</strong></td>
            </tr>
                ...
                <td colspan="3">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="codUsu_Cli" HeaderText="Cliente" />
